...
// I had trouble passing the last test. I didn't want to be boring and set adam.children equal to terah.children. I found that // children: terah.children // didn't work out because I was defining this in adam's object which was defined before terah's children property. Instead of moving adam's object, I decided to set them equal after the fact.

// How difficult was it to add and delete properties outside of the object itself?
// It wasn't too difficult. Just setting values equal to the property. I had to venture online for a brief moment to find the delete function.

// What did you learn about manipulating objects in this challenge?
// Order matters! Unlike declaring functions, which can be done at any point in the function, I have to set my object properties in order. I also remembered how important commas are in objects. It was a common error of mine.
//
